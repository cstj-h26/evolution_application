...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2]]);
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    _cache[1] || (_cache[1] = createBaseVNode("h1", null, "Application Electron avec Vue.js", -1)),
    createBaseVNode("button", {
      onClick: _cache[0] || (_cache[0] = (...args) => $options.openFormWindow && $options.openFormWindow(...args))
...
const _hoisted_1 = { class: "table-grid" };
const _hoisted_2 = { class: "inline-container" };
const _hoisted_3 = { class: "inline-container" };
const _hoisted_4 = { class: "inline-container" };
const _hoisted_5 = { class: "second-table-grid" };
const _hoisted_6 = { style: { "vertical-align": "middle", "margin-top": "40px" } };
const _hoisted_7 = { style: { "border": "1px solid grey" } };
const _hoisted_8 = { class: "third-table-grid" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    _cache[33] || (_cache[33] = createBaseVNode("h1", { style: { "color": "#26008B", "text-align": "center" } }, "Formulaire d'inscription", -1)),
    createBaseVNode("div", _hoisted_1, [
      _cache[23] || (_cache[23] = createBaseVNode("label", { for: "nom" }, "Nom :", -1)),
      ...
      _cache[24] || (_cache[24] = createBaseVNode("label", { for: "prenom" }, "Prénom :", -1)),
      withDirectives(createBaseVNode("input", {
        id: "prenom",
        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.prenom = $event),
        type: "text"
      }, null, 512), [
        [vModelText, $data.prenom]
      ]),
      _cache[25] || (_cache[25] = createBaseVNode("label", { for: "dateNaissance" }, "Date de naissance :", -1)),
      withDirectives(createBaseVNode("input", {
        id: "dateNaissance",
        "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.dateNaissance = $event),
        type: "date"
      }, null, 512), [
        [vModelText, $data.dateNaissance]
      ]),
      _cache[26] || (_cache[26] = createBaseVNode("label", { for: "email" }, "Adresse de courriel :", -1)),
      withDirectives(createBaseVNode("input", {
        id: "email",
      ...
      _cache[27] || (_cache[27] = createBaseVNode("label", { for: "region" }, "Région :", -1)),
      withDirectives(createBaseVNode("select", {
        id: "region",
        "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $data.region = $event)
      }, [..._cache[16] || (_cache[16] = [
        createBaseVNode("option", { value: "Laurentides" }, "Laurentides", -1),
        createBaseVNode("option", { value: "Laval" }, "Laval", -1),
        createBaseVNode("option", { value: "Lanaudière" }, "Lanaudière", -1),
        createBaseVNode("option", { value: "Montréal" }, "Montréal", -1)
      ])], 512), [
        [vModelSelect, $data.region]
      ]),
      _cache[28] || (_cache[28] = createBaseVNode("label", null, "Statut professionnel :", -1)),
      createBaseVNode("span", null, [
        createBaseVNode("div", _hoisted_2, [
          withDirectives(createBaseVNode("input", {
            id: "etudiant",
            type: "checkbox",
            "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => $data.statutProfessionnel = $event),
            value: "Étudiant"
          }, null, 512), [
            [vModelCheckbox, $data.statutProfessionnel]
          ]),
          _cache[17] || (_cache[17] = createBaseVNode("label", { for: "etudiant" }, "Étudiant", -1))
        ]),
        createBaseVNode("div", _hoisted_3, [
          withDirectives(createBaseVNode("input", {
            id: "salarie",
            type: "checkbox",
            "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => $data.statutProfessionnel = $event),
            value: "Salarié"
          }, null, 512), [
            [vModelCheckbox, $data.statutProfessionnel]
          ]),
          _cache[18] || (_cache[18] = createBaseVNode("label", { for: "salarie" }, "Salarié", -1))
        ]),
        createBaseVNode("div", _hoisted_4, [
          withDirectives(createBaseVNode("input", {
            id: "recherche",
            type: "checkbox",
            "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => $data.statutProfessionnel = $event),
            value: "Recherche de travail"
          }, null, 512), [
            [vModelCheckbox, $data.statutProfessionnel]
          ]),
          _cache[19] || (_cache[19] = createBaseVNode("label", { for: "recherche" }, "Recherche de travail", -1))
        ])
      ]),
      _cache[29] || (_cache[29] = createBaseVNode("label", null, "État matrimonial :", -1)),
      createBaseVNode("span", null, [
        createBaseVNode("div", null, [
          withDirectives(createBaseVNode("input", {
            id: "celibataire",
            type: "radio",
            "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => $data.etatMatrimonial = $event),
            value: "Célibataire"
          }, null, 512), [
            [vModelRadio, $data.etatMatrimonial]
          ]),
          _cache[20] || (_cache[20] = createBaseVNode("label", { for: "celibataire" }, "Célibataire", -1))
        ]),
        createBaseVNode("div", null, [
          withDirectives(createBaseVNode("input", {
            id: "fiance",
            type: "radio",
            "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => $data.etatMatrimonial = $event),
            value: "Fiancé"
          }, null, 512), [
            [vModelRadio, $data.etatMatrimonial]
          ]),
          _cache[21] || (_cache[21] = createBaseVNode("label", { for: "fiance" }, "Fiancé", -1))
        ]),
        createBaseVNode("div", null, [
          withDirectives(createBaseVNode("input", {
            id: "marie",
            type: "radio",
            "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => $data.etatMatrimonial = $event),
            value: "Marié"
          }, null, 512), [
            [vModelRadio, $data.etatMatrimonial]
          ]),
          _cache[22] || (_cache[22] = createBaseVNode("label", { for: "marie" }, "Marié", -1))
        ])
      ])
    ]),
    createBaseVNode("div", _hoisted_5, [
      createBaseVNode("span", null, [
        _cache[31] || (_cache[31] = createBaseVNode("label", null, " Faites un choix (2 ou +): ", -1)),
        withDirectives(createBaseVNode("select", {
          "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => $data.listeLangages = $event),
          multiple: "",
          style: { "width": "150px" }
        }, [..._cache[30] || (_cache[30] = [
          createBaseVNode("option", null, "C#", -1),
          createBaseVNode("option", null, "Java", -1),
          createBaseVNode("option", null, "Python", -1),
          createBaseVNode("option", null, "Ruby", -1),
          createBaseVNode("option", null, "Visual Basic .NET", -1),
          createBaseVNode("option", null, "JavaScript", -1),
          createBaseVNode("option", null, "Swift", -1),
          createBaseVNode("option", null, "Kotlin", -1)
        ])], 512), [
          [vModelSelect, $data.listeLangages]
        ])
      ]),
      createBaseVNode("span", _hoisted_6, [
        createBaseVNode("button", {
          onClick: _cache[12] || (_cache[12] = (...args) => $options.copierLangages && $options.copierLangages(...args)),
          style: { "margin-bottom": "10px" }
        }, "Copier >>"),
        createBaseVNode("button", {
          onClick: _cache[13] || (_cache[13] = (...args) => $options.viderLangages && $options.viderLangages(...args))
        }, "Vider <<")
      ]),
      createBaseVNode("span", null, [
        createBaseVNode("div", _hoisted_7, [
          _cache[32] || (_cache[32] = createBaseVNode("label", null, "Langages choisis :", -1)),
          createBaseVNode("ul", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($data.langagesChoisis, (langage) => {
              return openBlock(), createElementBlock("li", { key: langage }, toDisplayString(langage), 1);
            }), 128))
          ])
        ])
      ])
    ...
    createBaseVNode("div", _hoisted_8, [
      createBaseVNode("button", {
        onClick: _cache[14] || (_cache[14] = (...args) => $options.valider && $options.valider(...args))
      }, "Valider"),
      createBaseVNode("button", {
        onClick: _cache[15] || (_cache[15] = (...args) => $options.annuler && $options.annuler(...args))
      }, "Annuler")
    ])
  ]);
}
const Form = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-63d97118"]]);
const routes = [
  { path: "/", component: Home },
